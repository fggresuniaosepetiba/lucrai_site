...
public interface ICashForecastRepository
{
    ...
    Task<CashForecast> MarkAsReceivedAsync(Guid id, string company, string? userName);
    Task<CashForecast> MarkAsPaidAsync(Guid id, string company, string? userName);
    Task<CashForecast> MarkAsCancelledAsync(Guid id, string company, string? reason, string? userName);
